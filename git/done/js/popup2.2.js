...
(function ($) {
    ...
    $.Popup.settings = {
        ...
        'titleHeight'           : 20,               // height in pixels of the gallery title box
        'controlHeight'         : 30,               // height in pixels of the gallery navigation box
        'imageDesc'             : true,            // add a description box underneath the gallery image
        'autoSize'              : true,             // set whether the box with image in it will resize to the image size
        'boxWidth'              : 900,              // when autoSize is set to false, or no image then set the dimensions of the box in pixels
        'boxHeight'             : 530,              // when autoSize is set to false, or no image then set the dimensions of the box in pixels
        'centerImage'           : true,             // centers the image in a fixed size box
        'shadowLength'          : 30,               // set the width of the padding around the box for your drop shadows
    ...
    $.Popup.prototype = {
        ...
        displayImage : function() {
            ...
            if (this.opts.autoSize === false && this.opts.centerImage === true) {
                ...
                contentBox.find(".imgPane img").css({"display":"inline"});
            }
